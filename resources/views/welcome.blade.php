        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service-item">
                        <div class="icon">
                            <img src="{{ asset('user/assets/images/service-03.png') }}" alt="web experts" />
                        </div>
                        <div class="main-content">
                            <h4>Web Experts</h4>
                            <p>
            ...
            <div class="row event_box">
                <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 design">
                    <div class="events_item">
                        <div class="thumb">
                            <a href="#"><img src="{{ asset('user/assets/images/course-01.jpg') }}"
                                    alt="" /></a>
                ...
                <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 development">
                    <div class="events_item">
                        <div class="thumb">
                            <a href="#"><img src="{{ asset('user/assets/images/course-02.jpg') }}"
                                    alt="" /></a>
                ...
                <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 design wordpress">
                    <div class="events_item">
                        <div class="thumb">
                            <a href="#"><img src="{{ asset('user/assets/images/course-03.jpg') }}"
                                    alt="" /></a>
                ...
                <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 development">
                    <div class="events_item">
                        <div class="thumb">
                            <a href="#"><img src="{{ asset('user/assets/images/course-04.jpg') }}"
                                    alt="" /></a>
                            <span class="category">Development</span>
                            <span class="price">
                                <h6><em>$</em>450</h6>
                ...
                <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 wordpress development">
                    <div class="events_item">
                        <div class="thumb">
                            <a href="#"><img src="{{ asset('user/assets/images/course-05.jpg') }}"
                                    alt="" /></a>
                            <span class="category">Wordpress</span>
                            <span class="price">
                                <h6><em>$</em>320</h6>
                ...
                <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 wordpress design">
                    <div class="events_item">
                        <div class="thumb">
                            <a href="#"><img src="{{ asset('user/assets/images/course-06.jpg') }}"
                                    alt="" /></a>
                            <span class="category">Webdesign</span>
                            <span class="price">
                                <h6><em>$</em>240</h6>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="team-member">
                        <div class="main-content">
                            <img src="{{ asset('user/assets/images/member-01.jpg') }}" alt="" />
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team-member">
                        <div class="main-content">
                            <img src="{{ asset('user/assets/images/member-02.jpg') }}" alt="" />
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team-member">
                        <div class="main-content">
                            <img src="{{ asset('user/assets/images/member-03.jpg') }}" alt="" />
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team-member">
                        <div class="main-content">
                            <img src="{{ asset('user/assets/images/member-04.jpg') }}" alt="" />
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="item">
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="image">
                                    <img src="{{ asset('user/assets/images/event-01.jpg') }}" alt="" />
                                </div>
                            </div>
                            <div class="col-lg-9">
                                <ul>
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="item">
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="image">
                                    <img src="{{ asset('user/assets/images/event-02.jpg') }}" alt="" />
                                </div>
                            </div>
                            <div class="col-lg-9">
                                <ul>
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="item">
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="image">
                                    <img src="{{ asset('user/assets/images/event-03.jpg') }}" alt="" />
                                </div>
                            </div>
                            <div class="col-lg-9">
                                <ul>
